...
const char* sql_code_string(int code) {
  switch (code) {
      CASE_RETURN_TOKEN_UTF8(SQLITE_OK);
      CASE_RETURN_TOKEN_UTF8(SQLITE_ERROR);
      CASE_RETURN_TOKEN_UTF8(SQLITE_INTERNAL);
      CASE_RETURN_TOKEN_UTF8(SQLITE_PERM);
      CASE_RETURN_TOKEN_UTF8(SQLITE_ABORT);
      CASE_RETURN_TOKEN_UTF8(SQLITE_BUSY);
      CASE_RETURN_TOKEN_UTF8(SQLITE_LOCKED);
      CASE_RETURN_TOKEN_UTF8(SQLITE_NOMEM);
      CASE_RETURN_TOKEN_UTF8(SQLITE_READONLY);
      CASE_RETURN_TOKEN_UTF8(SQLITE_INTERRUPT);
      CASE_RETURN_TOKEN_UTF8(SQLITE_IOERR);
      CASE_RETURN_TOKEN_UTF8(SQLITE_CORRUPT);
      CASE_RETURN_TOKEN_UTF8(SQLITE_NOTFOUND);
      CASE_RETURN_TOKEN_UTF8(SQLITE_FULL);
      CASE_RETURN_TOKEN_UTF8(SQLITE_CANTOPEN);
      CASE_RETURN_TOKEN_UTF8(SQLITE_PROTOCOL);
      CASE_RETURN_TOKEN_UTF8(SQLITE_EMPTY);
      CASE_RETURN_TOKEN_UTF8(SQLITE_SCHEMA);
      CASE_RETURN_TOKEN_UTF8(SQLITE_TOOBIG);
      CASE_RETURN_TOKEN_UTF8(SQLITE_CONSTRAINT);
      CASE_RETURN_TOKEN_UTF8(SQLITE_MISMATCH);
      CASE_RETURN_TOKEN_UTF8(SQLITE_MISUSE);
      CASE_RETURN_TOKEN_UTF8(SQLITE_NOLFS);
      CASE_RETURN_TOKEN_UTF8(SQLITE_AUTH);
      CASE_RETURN_TOKEN_UTF8(SQLITE_FORMAT);
      CASE_RETURN_TOKEN_UTF8(SQLITE_RANGE);
      CASE_RETURN_TOKEN_UTF8(SQLITE_NOTADB);
      CASE_RETURN_TOKEN_UTF8(SQLITE_ROW);
      CASE_RETURN_TOKEN_UTF8(SQLITE_DONE);
